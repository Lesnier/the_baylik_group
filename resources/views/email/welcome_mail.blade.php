        ...
        <center style="width: 100%; background-color: #f1f1f1;">
            ...
            <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white" style="background-image: url('https://baylikgroup.com/public/email/images/bg_1.jpg'); background-size: cover; height: 400px;">
                            <div class="overlay"></div>
                            <table>
                                <tr>
                                    <td>
                                        <div class="text" style="padding: 0 3em; text-align: center;">
                                            <h2>Welcome to The Baylik Group</h2>
                                ...
                                <tr>
                                    <td class="bg_white email-section">
                                        <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                            <h2>Our Services</h2>
                                            <p>Our services are aimed at contractors, sellers, buyers who need a hand.</p>
                                        </div>
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-services">
                                                                <h3>Selling</h3>
                                                                <p>We guide you in the sale of your property in the shortest possible time.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td valign="top" width="33.333%" style="padding-top: 20px; background: rgba(0,0,0,.08);" class="services">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-services">
                                                                <h3>Buying</h3>
                                                                <p>Advice and accompaniment in the purchase. We find the right property for you.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td valign="top" width="33.333%" style="padding-top: 20px;" class="services">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-services">
                                                                <h3>Contractors</h3>
                                                                <p>We guide your effort in the right direction. We share unique opportunities.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-services" style="text-align: left; padding-left:25px;">
                                                                <div class="heading-section">
                                                                    <h2>Realstate Strategy</h2>
                                                                    <p>Only a small number of professionals are successful because they apply the best practices.</p>
{{--                                                                    <p><a href="#" class="btn btn-primary">Read more</a></p>--}}
                                ...
                                <tr>
                                    <td class="bg_white email-section">
                                        <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                            <h2>Projects</h2>
                                            <p>We participate in hundreds of projects, and manage the exploitation cycle.</p>
                                        </div>
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="text-align: left; padding-right: 10px;">
                                                    ...
                                                    <p>Baylik Group is the leading platform in Florida for training, development and growth in the world of real estate.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                                    ...
                                                    <ul>
                                                        <li><span class="text">8570 Stirling Rd STE 102-314, Hollywood, FL 33024</span></li>
                                                        <li><span class="text">Phone: 7862824657 </span></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="text-align: left; padding-left: 10px;">
                                                    ...
                                                    <ul>
                                                        <li><a href="https://baylikgroup.com/public/">Home</a></li>
                                                        <li><a href="https://baylikgroup.com/public/#what">About Us</a></li>
                                                        <li><a href="https://baylikgroup.com/public/#why">Mission</a></li>
                                                        <li><a href="https://baylikgroup.com/public/#service">Seller / Buyer</a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </table>
